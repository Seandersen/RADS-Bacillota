#!/usr/bin/env python3
"""
Defense system visualization for Bacillota RADS dataset.
...
# Paths
# ---------------------------------------------------------------------------
RESULTS     = Path("/Volumes/Duerkop-lab/Shelby/018_RADSBacillotaFinal/RADS/results/efb0058_bacillota_withbinom_complete")
DEFENSE_TSV = RESULTS / "defensefinder" / "defense_finder_genes.tsv"
INTERPRO_TSV = RESULTS / "interproscan_results.tsv"
SCORES_TSV  = RESULTS / "defense_scores.tsv"
GENUS_CACHE = Path("/tmp/bacillota_genus_cache.json")
...
# ---------------------------------------------------------------------------
# Bacillota genus → (family, order)
# ---------------------------------------------------------------------------
GENUS_TO_FAMILY = {
    # ── BACILLALES ────────────────────────────────────────────────────────────
    # Staphylococcaceae (dominant; keep first for visual prominence)
    "Staphylococcus":       ("Staphylococcaceae",    "Bacillales"),
    "Mammaliicoccus":       ("Staphylococcaceae",    "Bacillales"),
    "Macrococcus":          ("Staphylococcaceae",    "Bacillales"),
    "Macrococcoides":       ("Staphylococcaceae",    "Bacillales"),
    "Salinicoccus":         ("Staphylococcaceae",    "Bacillales"),
    "Jeotgalibaca":         ("Staphylococcaceae",    "Bacillales"),
    # Bacillaceae
    "Bacillus":             ("Bacillaceae",          "Bacillales"),
    "Peribacillus":         ("Bacillaceae",          "Bacillales"),
    "Neobacillus":          ("Bacillaceae",          "Bacillales"),
    "Cytobacillus":         ("Bacillaceae",          "Bacillales"),
    "Metabacillus":         ("Bacillaceae",          "Bacillales"),
    "Rossellomorea":        ("Bacillaceae",          "Bacillales"),
    "Heyndrickxia":         ("Bacillaceae",          "Bacillales"),
    "Psychrobacillus":      ("Bacillaceae",          "Bacillales"),
    "Ureibacillus":         ("Bacillaceae",          "Bacillales"),
    "Solibacillus":         ("Bacillaceae",          "Bacillales"),
    "Evansella":            ("Bacillaceae",          "Bacillales"),
    "Niallia":              ("Bacillaceae",          "Bacillales"),
    "Fictibacillus":        ("Bacillaceae",          "Bacillales"),
    "Gottfriedia":          ("Bacillaceae",          "Bacillales"),
    "Pseudalkalibacillus":  ("Bacillaceae",          "Bacillales"),
    "Shouchella":           ("Bacillaceae",          "Bacillales"),
    "Priestia":             ("Bacillaceae",          "Bacillales"),
    "Pristimantibacillus":  ("Bacillaceae",          "Bacillales"),
    "Rummeliibacillus":     ("Bacillaceae",          "Bacillales"),
    "Caldibacillus":        ("Bacillaceae",          "Bacillales"),
    "Caldifermentibacillus":("Bacillaceae",          "Bacillales"),
    "Thermaerobacillus":    ("Bacillaceae",          "Bacillales"),
    "Anaerobacillus":       ("Bacillaceae",          "Bacillales"),
    "Bengtsoniella":        ("Bacillaceae",          "Bacillales"),
    "Haloimpatiens":        ("Bacillaceae",          "Bacillales"),
    "Massiliimicrobium":    ("Bacillaceae",          "Bacillales"),
    # Listeriaceae
    "Listeria":             ("Listeriaceae",         "Bacillales"),
    "Paenilisteria":        ("Listeriaceae",         "Bacillales"),
    # Planococcaceae
    "Planococcus":          ("Planococcaceae",       "Bacillales"),
    "Kurthia":              ("Planococcaceae",       "Bacillales"),
    # Paenibacillaceae
    "Paenibacillus":        ("Paenibacillaceae",     "Bacillales"),
    # Lysinibacillaceae
    "Lysinibacillus":       ("Lysinibacillaceae",    "Bacillales"),
    # Alicyclobacillaceae
    "Alicyclobacillus":     ("Alicyclobacillaceae",  "Bacillales"),
    # Halobacillaceae
    "Halobacillus":         ("Halobacillaceae",      "Bacillales"),
    "Virgibacillus":        ("Halobacillaceae",      "Bacillales"),
    "Lentibacillus":        ("Halobacillaceae",      "Bacillales"),
    "Gracilibacillus":      ("Halobacillaceae",      "Bacillales"),
    "Salimicrobium":        ("Halobacillaceae",      "Bacillales"),
    # Anoxybacillaceae
    "Geobacillus":          ("Anoxybacillaceae",     "Bacillales"),
    "Parageobacillus":      ("Anoxybacillaceae",     "Bacillales"),
    # Oceanobacillaceae
    "Oceanobacillus":       ("Oceanobacillaceae",    "Bacillales"),
    # Exiguobacteraceae
    "Exiguobacterium":      ("Exiguobacteraceae",    "Bacillales"),
    # ── LACTOBACILLALES ───────────────────────────────────────────────────────
    # Enterococcaceae (dominant among Lactobacillales)
    "Enterococcus":         ("Enterococcaceae",      "Lactobacillales"),
    "Vagococcus":           ("Enterococcaceae",      "Lactobacillales"),
    "Tetragenococcus":      ("Enterococcaceae",      "Lactobacillales"),
    # Lactobacillaceae
    "Lactobacillus":        ("Lactobacillaceae",     "Lactobacillales"),
    "Lactiplantibacillus":  ("Lactobacillaceae",     "Lactobacillales"),
    "Lacticaseibacillus":   ("Lactobacillaceae",     "Lactobacillales"),
    "Limosilactobacillus":  ("Lactobacillaceae",     "Lactobacillales"),
    "Latilactobacillus":    ("Lactobacillaceae",     "Lactobacillales"),
    "Levilactobacillus":    ("Lactobacillaceae",     "Lactobacillales"),
    "Lentilactobacillus":   ("Lactobacillaceae",     "Lactobacillales"),
    "Loigolactobacillus":   ("Lactobacillaceae",     "Lactobacillales"),
    "Secundilactobacillus": ("Lactobacillaceae",     "Lactobacillales"),
    "Fructilactobacillus":  ("Lactobacillaceae",     "Lactobacillales"),
    "Companilactobacillus": ("Lactobacillaceae",     "Lactobacillales"),
    "Liquorilactobacillus": ("Lactobacillaceae",     "Lactobacillales"),
    "Paucilactobacillus":   ("Lactobacillaceae",     "Lactobacillales"),
    "Ligilactobacillus":    ("Lactobacillaceae",     "Lactobacillales"),
    "Apilactobacillus":     ("Lactobacillaceae",     "Lactobacillales"),
    "Dellaglioa":           ("Lactobacillaceae",     "Lactobacillales"),
    "Bombilactobacillus":   ("Lactobacillaceae",     "Lactobacillales"),
    "Furfurilactobacillus": ("Lactobacillaceae",     "Lactobacillales"),
    "Pediococcus":          ("Lactobacillaceae",     "Lactobacillales"),
    # Streptococcaceae
    "Streptococcus":        ("Streptococcaceae",     "Lactobacillales"),
    "Lactococcus":          ("Streptococcaceae",     "Lactobacillales"),
    "Pseudolactococcus":    ("Streptococcaceae",     "Lactobacillales"),
    # Leuconostocaceae
    "Leuconostoc":          ("Leuconostocaceae",     "Lactobacillales"),
    "Oenococcus":           ("Leuconostocaceae",     "Lactobacillales"),
    # Carnobacteriaceae
    "Carnobacterium":       ("Carnobacteriaceae",    "Lactobacillales"),
    # Aerococcaceae
    "Aerococcus":           ("Aerococcaceae",        "Lactobacillales"),
    "Helcococcus":          ("Aerococcaceae",        "Lactobacillales"),
    "Gemella":              ("Aerococcaceae",        "Lactobacillales"),
    "Trichococcus":         ("Aerococcaceae",        "Lactobacillales"),
    # ── EUBACTERIALES (Clostridiales) ─────────────────────────────────────────
    # Clostridiaceae
    "Clostridium":          ("Clostridiaceae",       "Eubacteriales"),
    "Paraclostridium":      ("Clostridiaceae",       "Eubacteriales"),
    "Sedimentibacter":      ("Clostridiaceae",       "Eubacteriales"),
    # Lachnospiraceae
    "Blautia":              ("Lachnospiraceae",      "Eubacteriales"),
    "Lacrimispora":         ("Lachnospiraceae",      "Eubacteriales"),
    "Butyrivibrio":         ("Lachnospiraceae",      "Eubacteriales"),
    "Dorea":                ("Lachnospiraceae",      "Eubacteriales"),
    "Enterocloster":        ("Lachnospiraceae",      "Eubacteriales"),
    "Agathobaculum":        ("Lachnospiraceae",      "Eubacteriales"),
    "Intestinimonas":       ("Lachnospiraceae",      "Eubacteriales"),
    "Eisenbergiella":       ("Lachnospiraceae",      "Eubacteriales"),
    "Faecalimonas":         ("Lachnospiraceae",      "Eubacteriales"),
    "Emergencia":           ("Lachnospiraceae",      "Eubacteriales"),
    # Ruminococcaceae
    "Ruminococcus":         ("Ruminococcaceae",      "Eubacteriales"),
    "Faecalibacterium":     ("Ruminococcaceae",      "Eubacteriales"),
    "Flavonifractor":       ("Ruminococcaceae",      "Eubacteriales"),
    "Acetivibrio":          ("Ruminococcaceae",      "Eubacteriales"),
    "Butyricicoccus":       ("Ruminococcaceae",      "Eubacteriales"),
    "Lawsonibacter":        ("Ruminococcaceae",      "Eubacteriales"),
    "Ethanoligenens":       ("Oscillospiraceae",     "Eubacteriales"),
    "Pusillibacter":        ("Oscillospiraceae",     "Eubacteriales"),
    "Vescimonas":           ("Oscillospiraceae",     "Eubacteriales"),
    "Ruthenibacterium":     ("Oscillospiraceae",     "Eubacteriales"),
    # Peptostreptococcaceae
    "Peptostreptococcus":   ("Peptostreptococcaceae","Eubacteriales"),
    "Anaerococcus":         ("Peptostreptococcaceae","Eubacteriales"),
    "Parvimonas":           ("Peptostreptococcaceae","Eubacteriales"),
    # Eubacteriaceae
    "Eubacterium":          ("Eubacteriaceae",       "Eubacteriales"),
    # Misc Eubacteriales
    "Owariibacterium":      ("Eubacteriales",        "Eubacteriales"),
    "Faecalibaculum":       ("Eubacteriales",        "Eubacteriales"),
    "Claveliimonas":        ("Eubacteriales",        "Eubacteriales"),
    "Thomasclavelia":       ("Eubacteriales",        "Eubacteriales"),
    "Fusibacter":           ("Eubacteriales",        "Eubacteriales"),
    "Chakrabartyella":      ("Eubacteriales",        "Eubacteriales"),
    # ── OTHER BACILLOTA ───────────────────────────────────────────────────────
    "Thermoanaerobacterium":("Thermoanaerobacteraceae","Thermoanaerobacterales"),
    "Veillonella":          ("Veillonellaceae",      "Veillonellales"),
    "Megamonas":            ("Veillonellaceae",      "Veillonellales"),
    "Anaerosinus":          ("Veillonellaceae",      "Veillonellales"),
    "Halanaerobium":        ("Halanaerobiaceae",     "Halanaerobiales"),
    "Desulfosporosinus":    ("Peptococcaceae",       "Eubacteriales"),
    "Dehalobacter":         ("Peptococcaceae",       "Eubacteriales"),
    "Sporomusa":            ("Sporomusaceae",        "Selenomonadales"),
    "Wukongibacter":        ("Other Bacillota",      "Other Bacillota"),
    "Paludihabitans":       ("Other Bacillota",      "Other Bacillota"),
    "Intestinibacillus":    ("Other Bacillota",      "Other Bacillota"),
    # ── UNCLASSIFIED ─────────────────────────────────────────────────────────
    "Unknown":              ("Unclassified",         "Unclassified"),
}

# Family display order for heatmap rows (ordered by Bacillota taxonomy)
FAMILY_ORDER = [
    # Bacillales
    "Staphylococcaceae",
    "Bacillaceae",
...
# Order → display label and families it spans
ORDER_GROUPS = [
    ("Bacillales",         ["Staphylococcaceae", "Bacillaceae", "Listeriaceae",
                            "Planococcaceae", "Paenibacillaceae", "Lysinibacillaceae",
                            "Alicyclobacillaceae", "Halobacillaceae", "Anoxybacillaceae",
                            "Oceanobacillaceae", "Exiguobacteraceae"]),
    ("Lactobacillales",    ["Enterococcaceae", "Lactobacillaceae", "Streptococcaceae",
                            "Leuconostocaceae", "Carnobacteriaceae", "Aerococcaceae"]),
    ("Eubacteriales",      ["Clostridiaceae", "Lachnospiraceae", "Ruminococcaceae",
                            "Oscillospiraceae", "Peptostreptococcaceae",
                            "Eubacteriaceae", "Eubacteriales", "Peptococcaceae"]),
    ("Other",              ["Thermoanaerobacteraceae", "Veillonellaceae",
                            "Halanaerobiaceae", "Sporomusaceae",
                            "Other Bacillota", "Unclassified"]),
]


def genus_to_family_order(genus: str) -> tuple[str, str]:
    return GENUS_TO_FAMILY.get(genus, ("Other Bacillota", "Other Bacillota"))
...
def load_defense_systems() -> pd.DataFrame:
    """Load unique defense genes from defense_finder_genes.tsv (dedup by hit_id)."""
    rows = []
    seen_hits = set()
...
def load_interpro_typeIV(existing_hit_ids: set) -> pd.DataFrame:
    ...
    TYPE4_IPR  = {"IPR007560"}    # Type IV Mrr
    rows = []
    seen = set()
    if not INTERPRO_TSV.exists():
        return pd.DataFrame(rows)
    with open(INTERPRO_TSV) as fh:
        for line in fh:
            ...
            chrom_acc = m.group(1) if m else ""
            label = "DUF262 (putative Type IV)" if pfam_acc in TYPE4_PFAM else "Type IV Mrr"
            rows.append({
                "hit_id":      orf_id,
...
def load_acc_to_genus() -> dict[str, str]:
    """Load pre-built genus cache (built by fetch_bacillota_genus2.py)."""
    if not GENUS_CACHE.exists():
        raise FileNotFoundError(f"Genus cache not found at {GENUS_CACHE}. "
                                "Run fetch_bacillota_genus2.py first.")
    with open(GENUS_CACHE) as f:
        return json.load(f)
...
# ===========================================================================
def make_figure_AB(df_sys: pd.DataFrame, acc_to_genus: dict, out_path: Path):

    # ---- Data preparation ----
    cat_counts = df_sys["category"].value_counts()
    cats_present = list(cat_counts.index)
...
# ===========================================================================
# FIGURE 3 — Histogram: defense scores for co-transcribed ORFs
# ===========================================================================
...
if __name__ == "__main__":
    ...
    print("Loading genus map...")
    acc_to_genus = load_acc_to_genus()
    resolved = df_sys["chrom_acc"].map(acc_to_genus).notna().sum()
    print(f"  {resolved} / {len(df_sys)} genes with genus resolved")

    # Show which genera appear and their family mapping coverage
    genera_in_data = set(df_sys["chrom_acc"].map(acc_to_genus).dropna())
    unmapped = [g for g in genera_in_data if g not in GENUS_TO_FAMILY]
    if unmapped:
        print(f"  WARNING: {len(unmapped)} genera not in GENUS_TO_FAMILY: {unmapped}")
