# RADS — Bacillota Defense System Analysis

Analysis of defense systems flanking EFB_0058 (recombinase) across **13,553 Bacillota genomes** using the [RADS pipeline](https://github.com/Seandersen/RADS).
...
| Defense genes identified | 4,176 |
| Co-transcribed ORFs | 2,827 |

Results are in `results/efb0058_bacillota_withbinom_complete/`.
